;(function(global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : typeof define === 'function' && define.amd
      ? define(['@fortawesome/fontawesome', 'prop-types', 'react'], factory)
      : (global['react-fontawesome'] = factory(
          global.FontAwesome,
          global.PropTypes,
          global.React
        ))
  ...
  fontawesome =
    fontawesome && fontawesome.hasOwnProperty('default')
      ? fontawesome['default']
      : fontawesome
  PropTypes =
  ...
  function convert(createElement, element) {
    ...
    var children = (element.children || []).map(
    ...
    return createElement.apply(
      undefined,
      [element.tag, _extends({}, mixins.attrs, remaining)].concat(
  ...
  function FontAwesomeIcon$1(props) {
    ...
    var classes = objectWithKey(
      'classes',
      [].concat(
        toConsumableArray(classList(props)),
        toConsumableArray(className.split(' '))
      )
    )
    ...
    var renderedIcon = fontawesome.icon(
      icon,
      _extends({}, classes, transform, mask, {
        symbol: symbol
      })
    )
